...
public class Variable implements Expression {
    ...
    // the difference between araylist and simply a list, is that we can extend the arraylist what we can't do with a list 
    protected static ArrayList <String> usedID = new ArrayList <String> (); // the table where we hold all the id's

    public Variable (String identificateur, double nombre) throws IdException {
        if (usedID.indexOf(identificateur) != -1) throw new IdException(identificateur); // exception in constructor 
